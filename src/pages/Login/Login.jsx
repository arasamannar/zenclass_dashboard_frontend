        ...
        <div className='modal-dialog'>
          <div className='modal-content'>
            <div className='modal-header'>
              <h4 className='modal-title'>Welcome to Zen Class Dashboard</h4>
            </div>
            <div className='modal-body'>
              for Student Login use below ID or create new one: <br />
              <span className='mx-5'> Email : helloworld@gmail.com</span> <br />
              <span className='mx-5'> password : Pass@123</span> <br />
              <hr />
